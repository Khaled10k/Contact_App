// ignore_for_file: sized_box_for_whitespace, prefer_const_constructors, prefer_const_literals_to_create_immutables, prefer_is_empty
                ...
                children: [
                    ...
                    children: [
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: _image == null
                              ? Lottie.asset(
                                  'assets/animation/image_picker.json') // لعرض الرسوم المتحركة في حالة عدم وجود صورة
                              : ClipRRect(
                                  borderRadius: BorderRadius.circular(16),
                                  child: Image.file(
                                    _image!, // عرض الصورة المختارة
                                    fit: BoxFit.fill,
                                  ),
                                ),
                        ),
                  ...
                  SizedBox(
                    child: TextFormField(
                      ...
                      onChanged: (value) {
                        setDialogState(
                            () {}); // تحديث واجهة المستخدم عند تغيير القيمة
                      },
                    ),
                  ),
                  SizedBox(height: 8),
